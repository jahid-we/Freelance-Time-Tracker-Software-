              ...
              <form>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <div class="form-check">
                    <input type="checkbox" v-model="remember" class="form-check-input" value="true" id="remember" />
                    <label class="form-check-label" for="remember">Remember Me</label>
                  </div>
                  <Link href="/reset-link" class="small px-2">Forgot Password?</Link>
                </div>

                <button type="submit" @click.prevent="handleLogin()" class="btn btn-dark w-100">Login</button>

                <div class="text-center mt-3">
                  Don't have an account?
                  <Link href="/registerPage">Register</Link> <br>
                </div>
              </form>
            </div>
          </div>
