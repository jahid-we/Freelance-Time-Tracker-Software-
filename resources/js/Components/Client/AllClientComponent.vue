...
const reportPage = () => router.visit("/reports");
...
<template>
  <div class="card bg-primary-subtle border-primary m-5 pb-5 shadow">
    ...
    <div class="card-body">
      <!-- Action Buttons -->
      <Button @click.prevent="handleCreate()" class="btn hover-effect btn-primary shadow mb-3">
        <i class="bi bi-person-plus-fill me-1"></i> Add New Contact
      </Button>
      <Button @click.prevent="projectPage()" class="btn hover-effect btn-success shadow mb-3 mx-2">
        <i class="bi bi-kanban"></i> Projects
      </Button>
      <Button @click.prevent="timeLogPage()" class="btn hover-effect btn-warning shadow mb-3 mx-2">
        <i class="bi bi-clock"></i> Time Logs
      </Button>
      <Button @click.prevent="reportPage()" class="btn hover-effect btn-info shadow mb-3 mx-2">
        <i class="bi bi-bar-chart-line"></i> Reports
      </Button>
      <Button @click.prevent="handleDeleteALL()" class="btn hover-effect btn-danger shadow mb-3 mx-2">
      ...
      <div class="flex gap-3 mb-3">
        ...
        <input v-model="search" type="text" placeholder="Search..." class="form-control stylish-input" />
      </div>
      ...
      >
        <template #item-actions="{ id }">
          <div class="d-flex justify-content-center align-items-center flex-wrap gap-2">
            <button class="btn btn-sm btn-outline-primary" @click="handleEdit(id)">
              <i class="bi bi-pencil"></i>
            </button>
            <button class="btn btn-sm btn-outline-danger" @click="handleDelete(id)">
